...
class OrderLabController extends Controller
{
     ...
     * @return mixed
     */
    public function actionIndex($no_reg = null, $no_rm = null)
    {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Pesan Order Lab",
                    'content' => '<span class="text-success">Create OrderLab success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing OrderLab model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing OrderLab model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
